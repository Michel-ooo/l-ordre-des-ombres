      ...
      <div className="min-h-[calc(100vh-12rem)] flex flex-col items-center justify-center">
        ...
        >
          <motion.img
            ...
            className="w-32 h-32 mx-auto mb-8 lunar-glow"
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
          ...
          <p className="text-muted-foreground text-lg max-w-md mx-auto mb-2">
            Bienvenue, <span className="text-foreground font-heading">{profile?.pseudonym || 'Initié'}</span>
          </p>
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              <Link
                to={feature.link}
                className="ritual-card p-6 block h-full group hover:lunar-glow transition-all duration-500"
              >
